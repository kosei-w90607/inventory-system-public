...
| 2 | SPEC-WF-UI13WER-D1 | checklist 8 項目の個別 token（packet AC ①〜⑧: collect_commands / specta::specta / generate_bindings / design_compliance_test / 必須セクション / generate_traceability / generate:routes / navigation） | 各 1 hit 以上 |
