...
- C3: 36 箇所の test assertion が `CmdErrorKind::Variant` 比較へ移行し、restore 3 値を含む既存 test が全て pass する（値・分岐・error_id 相関・restore 意味論は不変）
