...
| BIZ-07-D3 同一 TX 必須ログ（D-6 例外） | 36-biz §21.4 ステップ5 + エラーハンドリング / 35-biz「BIZ-05/06/07 でも継承」への fix_integrity 例外注記 / D-051 の例外現状整理 | Matrix #6（anchor + 例外理由明記） | non-scope（実装は follow-up PR） |
