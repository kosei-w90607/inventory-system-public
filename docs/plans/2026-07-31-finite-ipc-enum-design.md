...
- family 一覧の漏れ（inventory 調査 + round 1/2 追補の 14 family + 対象外 3 系の理由の妥当性、CHECK 制約付き有限集合の全数突合 — round 2 が schema_v1.rs 全 CHECK 列挙で (13)(14) を検出した方法を Final Review でも再実行）
