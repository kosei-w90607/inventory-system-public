...
| REQ-402 | 商品マスタから対応 POS 向け PLU データを永続 memory No. で生成・保存できる | `spec/requirements.md`; `function-design/25-io-plu-formatter.md`; `function-design/33-biz-plu-export-service.md`; `function-design/67-ui-plu-export.md` | superseded | 原典の形式・容量前提を adapter 契約と D-072 の slot 永続割当へ置換した。Diff / Full とも投入可 |
