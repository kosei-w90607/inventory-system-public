...
- **利用者配慮**:
  ...
  - 部門フィルタ・未入力のみ表示の絞り込みで該当 0 件のときは「絞り込みを解除」ボタンで既定条件へ一括復帰できる（filter-empty reset、[design-system/02-component-catalog.md](design-system/02-component-catalog.md) ⑥ 参照）。
